...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x6_3(
		...
		KC_LGUI, KC_Z, KC_X, KC_C, KC_V, KC_B, 		KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, MO(3),
		MO(2), KC_LSFT, KC_ENT, 					KC_SPC, MO(1), KC_LCTL
	),
	[1] = LAYOUT_split_3x6_3(
		KC_TAB, KC_1, KC_2, KC_3, KC_4, KC_5, 					KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC,
		KC_LCTL, KC_EQL, KC_LBRC, KC_LCBR, KC_LPRN, KC_MINS, 	KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_GRAVE,
		KC_LSFT, KC_PLUS, KC_RBRC, KC_RCBR, KC_RPRN, KC_UNDS, 	KC_NO, KC_PIPE, KC_BSLS, KC_TILDE, KC_CIRC, KC_DEL,
		MO(2), KC_LSFT, KC_ENT, 								KC_SPC, _______, KC_TRNS
	),
	[2] = LAYOUT_split_3x6_3(
		...
		KC_NO, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), LGUI(KC_DEL), 										LGUI(KC_H), LGUI(KC_J), LGUI(KC_K), LGUI(KC_L), KC_NO, KC_NO,
		KC_TRNS, KC_TRNS, LGUI(KC_ENT), 																			KC_TRNS, KC_TRNS, KC_TRNS
	),
	[3] = LAYOUT_split_3x6_3(
		KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 										KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6,
		KC_NO, RALT(KC_A), RALT(KC_S), RALT(KC_U), RALT(KC_O), KC_NO, 		KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,
